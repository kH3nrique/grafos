...
void atualizaMovimentacao(struct Filial* filial, const char* filial_um, const char* filial_dois)
{
    ...
    {
        if ((strcmp(filial->filiais[filial->grafo[i]], filial_um) == 0 && strcmp(filial->filiais[filial->grafo[i+1]], filial_dois) == 0) ||
            (strcmp(filial->filiais[filial->grafo[i]], filial_dois) == 0 && strcmp(filial->filiais[filial->grafo[i+1]], filial_um) == 0))
        {
            filial->custo[i] = 0.0;
    ...
    cout << "Custo entre " << filial_um << " e " << filial_dois << " não existe. Insira o novo custo: ";
    cin >> filial->custo[filial->andaCustos];
    filial->andaCustos++;
}
...
void executarMenuFilial(struct Filial* filial)
{
    ...
    do
    {
        ...
        case 3:
            ...
            cout << "\n";
            system("cls");
            cout << "\t\tLISTA DE FILIAIS PROXIMAS\n\n";
        ...
        case 6:            
            cout << "\n";
            system("cls");
            cout << "\t\tCALCULAR CUSTOS DE FILIAIS\n\n";
